    ...
    return (
      <div>
        <div className="blogPostSection">
          ...
          <a className="containerLink" key="1" href="/post/what-is-western-esotericism">
          ...
          <a className="containerLink" key="2" href="/post/the-problem-with-open-occult-communities">
            <div className="blog-post-container waves-effect waves-light">
